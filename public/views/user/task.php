                                    ...
                                    <?php foreach ($todo as $value) { ?>
                                        ...
                                        <div class="btn-group">
                                            <form name="Complete" id="Complete" method="post" action="/Todo/Complete/<?= $user->getID() ?>">
                                                ...
                                                <td><input class="btn btn-primary" id="groupbtn1" type="submit" name="Complete" value="Complete"><i class="far fa-eye"></i>
                                                    <input type="hidden" name="hidden_complete" value="<?= $edit ?>">
                                            </form>
                                            <form name="Delete" id="DeleteTask" onclick="DeleteTask()" method="post" action="/Todo/Delete/<?= $user->getID() ?>">
                                                <input class="btn btn-primary" id="groupbtn1" type="submit" name="Delete" value="Delete">
                                                <input type="hidden" name="hidden_delete" value="<?= $edit ?>">
                                            </form>
                                            <button type="button" class="btn btn-primary" id="groupbtn1" data-toggle="modal" data-target="#myModal-<?= $edit ?>">
                                                Edit
                                            </button>
                                            </td>
                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form name="Edit" id="Edit" method="post" action="/Todo/Edit/<?= $user->getID() ?>">
                                                            ...
                                                            <label for="title">Title:</label><input type="text" name="title" value="<?= $value->getTitle(); ?>"><br>
